"""The guarded Poisson fits behind the calibration and diagnostic tables.

Each test states the failure it prevents. The guards exist because the unguarded fit
returned plausible numbers for populations that identify nothing, and a plausible
number survives into a published table.
"""
