...
Generated measurements and methodological notes. Interpretation is maintained separately in [the authored analysis](../../../docs/ANALYSIS.md), is tied to a named experiment, and is not updated by report generation. NA denotes an unavailable metric.
