...
once in an isolated commit; the existing workflow tests passed unchanged. All five captures
...
An unfinished or unresolvable game is pending; an unresolved name needs re-importing; a
